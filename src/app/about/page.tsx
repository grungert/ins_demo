          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><a href="/#research" className="hover:text-green-400 transition-colors duration-300">Research</a></li>
                <li><a href="/#people" className="hover:text-pink-400 transition-colors duration-300">People</a></li>
