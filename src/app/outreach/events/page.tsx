          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><Link href="/outreach/publishing" className="hover:text-red-400 transition-colors duration-300">Publishing</Link></li>
                <li><Link href="/outreach/collaborations" className="hover:text-pink-400 transition-colors duration-300">Collaborations</Link></li>
